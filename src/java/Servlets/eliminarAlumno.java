...
import DAO.Alumno;
import Negocios.buscarAlumno;
import Negocios.eliminaAlumno;
...
public class eliminarAlumno extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            String message = "Se elimino correctamente el alumno";
            ...
            String temp = sc.getRealPath("/WEB-INF/temp.txt");
            temp = temp.replace('\\', '/');
            if (buscarAlumno.buscarAlumnoById(idAlumno, path) != null) {
                
                eliminaAlumno.delete(idAlumno, path, temp);
                

            } else {
                message = "No se encontro el alumno registrado";
