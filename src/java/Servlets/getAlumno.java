...
public class getAlumno extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            path = path.replace('\\', '/');
            Alumno alumno = buscarAlumno.buscarAlumnoById(idAlumno, path);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet getAlumno</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet getAlumno at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
